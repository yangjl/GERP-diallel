...
plot_adk_gerp <- function(outfile, getpdf, fsize=18){
    
    dat <- fread("largedata/gerpdat0x_noB73.csv", data.table=FALSE)
...
####
plot_adk_gerp(outfile="graphs/SFig_adk_noB73.pdf", getpdf=TRUE, fsize=14)
