...
gsfiles <- list.files(path="/home/jolyang/Documents/Github/pvpDiallel/largedata/newGERPv2/genegeno", 
...
run_GenSel4(inputdf, inpdir="largedata/newGERPv2/genegeno", cmdno = 1,
