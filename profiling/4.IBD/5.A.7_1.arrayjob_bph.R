...
library(farmeR)
####### For trait perse
phenopwd <- "/home/jolyang/Documents/Github/pvpDiallel/largedata/pheno/CV5fold_BPH/"
...
run_GenSel4(inputdf=inputdf3, inpdir="largedata/newGERPv2/allgeno_bph_k5", cmdno=50,
