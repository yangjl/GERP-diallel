...
library(farmeR)
####### For trait perse
phenopwd <- "/home/jolyang/Documents/Github/GERP-diallel/largedata/pheno/CV5fold/"
...
###>>> RUN: sbatch -p serial --mem 1500 --ntasks=1 --time=120:00:00 slurm-script/run_gensel_array.sh
...
###>>> RUN: sbatch -p bigmemm --mem 6G --ntasks=1 --time=120:00:00 slurm-script/run_gensel_d2_array.sh
...
run_GenSel4(inputdf=inputdf3, inpdir="largedata/newGERPv2/allgeno_perse_k5", cmdno=500,
            ...
            email="yangjl0930@gmail.com", runinfo = c(FALSE, "bigmemm", 1) )
###>>> In this path: cd /home/jolyang/Documents/Github/pvpDiallel
###>>> RUN: sbatch -p bigmemm --mem 6G --ntasks=1 --time=100:00:00 slurm-script/run_gensel_h2_array.sh
